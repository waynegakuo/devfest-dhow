...
**Font Usage Rules:**
- **Primary Font:** "Architects Daughter" is used for body text, headers, and most content to maintain a creative, handwritten feel.
- **Secondary Font:** "Roboto" is used for UI elements requiring high readability.
- **Special Font:** "Google Sans" is exclusively for the navigator sidebar.
